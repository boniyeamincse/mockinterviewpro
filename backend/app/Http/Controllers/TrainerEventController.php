...
class TrainerEventController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'target_audience' => 'nullable|array|max:10',
            'target_audience.*' => 'string|max:255',
            'meeting_type' => 'nullable|string|in:google_meet,zoom,platform_video,own_system',
            'difficulty_level' => 'nullable|string|in:beginner,intermediate,advanced,mixed',
